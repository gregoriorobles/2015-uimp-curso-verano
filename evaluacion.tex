...
%% Metadatos del PDF.
\hypersetup{
  pdftitle={Evaluación de Proyectos Scratch},
  pdfauthor={Gregorio Robles, Agustín Santos},
...
\title{Análisis de aplicaciones con Dr.Scratch}
\subtitle{}
\institute{\{grex,asantos\}@gsyc.urjc.es \\
GSyC/Libresoft, Universidad Rey Juan Carlos}
\author{Gregorio Robles, Agustín Santos}
\date{Curso de Verano UIMP, Valencia, 10 de julio de 2015}
...
{\tiny
(cc) 2015 Gregorio Robles and Jesús Moreno León and Agustín Santos Méndez\\
...
\begin{frame}
\frametitle{¿Por qué una herramienta como Dr. Scratch? (I)}
\begin{figure}[t!]
\begin{center}
\includegraphics[width=5cm, height=6cm]{figs/cara.png}
\end{center}
\label{fig:corrigiendo}
\end{figure}
\begin{center}
...
\begin{frame}
\frametitle{¿Por qué una herramienta como Dr. Scratch? (y II)}
\begin{figure}[t!]
\begin{center}
\includegraphics[width=10cm, height=6cm]{figs/pylint.png}
\end{center}
\label{fig:pylint}
\end{figure}
\begin{center}
...
\begin{frame}
\frametitle{Revisión de la literatura}
\begin{columns}[T]
    \begin{column}{1\textwidth}
     \begin{block}{Evaluación de proyectos Scratch}
\begin{itemize}
  \item Varios marcos para realizar análisis manuales.
  \item \texttt{Scrape}: Analizador del portfolio de un usuario para visualizar los bloques utilizados.
  \item \texttt{Hairball}: Analizador estático de proyectos Scratch inspirado en \texttt{lint} para detectar errores de programación.
\end{itemize}
    \end{block}
    \end{column}
  \end{columns}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Malos hábitos de programación con Scratch (I)}
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Malos hábitos de programación con Scratch (y II)}

  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
 
     \begin{block}{Ejemplo de código repetido}
\begin{figure}[t!]
\begin{center}
...
\end{figure}
    ...
    \end{column}
    \begin{column}{0.5\textwidth}
     \begin{block}{Evitar la repetición de código}
\begin{figure}[t!]
\begin{center}
\includegraphics[width=5.4cm,height=2.5cm]{figs/CodeRepetition2.png}
\end{center}
Deben definirse bloques para evitar la repetición de código
...
\frametitle{Desarrollo de plug-ins para \texttt{Hairball}}
  ...
  \begin{columns}[T]
    \begin{column}{1\textwidth}
     \begin{block}{\vspace{0.1cm}\center{Desarrollamos dos plug-ins para \texttt{Hairball} para detectar automáticamente estos malos hábitos de programación}\vspace{0.1cm}}
\vspace{0.3cm}
\begin{enumerate}
...
\begin{frame}
\frametitle{Análisis del repositorio de proyectos Scratch}
...
\begin{center}
  ...
  \end{tabular}
\end{center}
\caption{Análisis de 100 proyectos Scratch descargados aleatoriamente}
\label{table:results1}
\end{table}
\end{frame}

%--------------------------------------------------------
\usebackgroundtemplate{\includegraphics[width=13cm, height=9cm]{figs/drscratch.png}}
% background: http://www.wim-network.org/wp-content/uploads/2012/04/iceberg.jpg
...
%--------------------------------------------------------
\begin{frame}
\frametitle{Dr. Scratch: análisis del Pensamiento Computacional (y II)}
\begin{figure}[t!]
\begin{center}
...
%--------------------------------------------------------
\usebackgroundtemplate{\includegraphics[width=13cm]{figs/TallerProfes.jpg}}
\begin{frame}
\frametitle{Taller de Dr. Scratch para docentes}

\end{frame}
\usebackgroundtemplate{}
%--------------------------------------------------------
\usebackgroundtemplate{\includegraphics[width=15cm,height=9cm]{figs/TallerCEIP.jpg}}
\begin{frame}
\frametitle{Taller de Dr. Scratch para estudiantes}
\begin{columns}[T]
    \begin{column}{0.8\textwidth}
     \begin{block}{Aprendiendo con Dr. Scratch}
     \begin{table}
\begin{center}
  \begin{tabular}{ | l | c |}
   \hline
      & Puntuación PC \\ \hline\hline
    Pre & 12.43 \\ \hline
    Post & 13.87 \\ \hline
    Mejora & 1.44  \\ \hline
    \hline    
  \end{tabular}
\end{center}
\caption{Análisis de la evolución de los proyectos}
...
\begin{enumerate}
  ...
  \item Cuentas para docentes.
  \item Ludificación y red social.
  \item Plug-ins para navegadores.
  \item Correlación con otros marcos de evaluación.
\end{enumerate}
\vspace{\baselineskip}
\vspace{\baselineskip}
